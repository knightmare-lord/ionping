...
def main():
    ...
    parser.add_argument('-t', '--timeout', help='Timeout duration in seconds (Default 0.8 seconds)', type=float, default=0.8)
    ...
    if args.timeout <= 0:
        print(f'[e] Specified timeout must be greater than zero')
        exit(1)
